...
function d(e, t) {
    ...
    for (n = 0; n < e.length; n += 16)
        ...
        f = c(f, p = s(p, h, m, f, e[n + 15], 22, 1236535329), h, m, e[n + 1], 5, -165796510),
        ...
        f = u(f, p = c(p, h, m, f, e[n + 12], 20, -1926607734), h, m, e[n + 5], 4, -378558),
...
var q = function(e, t, n) {
    return t ? n ? b(t, e) : h(b(t, e)) : n ? v(e) : h(v(e))
}
